...
def parse_args():
    ...
    parser.add_argument('--video', default=r'F:\2023_2\CapstoneProject\mmaction2\project\dataset\gesture_video_dataset\A001\A001_0.mp4', help='video file/url')
    parser.add_argument('--out_filename', default=r'F:\2023_2\CapstoneProject\mmaction2\project\dataset\pipeline_test', help='output filename')
    parser.add_argument(
        '--config',
        default=('F:/2023_2/CapstoneProject/mmaction2/project/config/'
                 'stgcn_8xb16-joint-u100-80e_ntu60-xsub-keypoint-2d.py'),
        help='skeleton model config file path')
    parser.add_argument(
        '--checkpoint',
        default=('F:/2023_2/CapstoneProject/mmaction2/project/Weight/'
                 'stgcn_epoch_30.pth'),
