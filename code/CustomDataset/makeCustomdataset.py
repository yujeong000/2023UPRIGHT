...
from etc.Utils import get_files, get_last_directory_name, make_dir, get_subdirectories
...
if __name__ == '__main__':
    ...
    ### json2pkl
    #입력 데이터셋 폴더
    data_dir_list = get_subdirectories(r'F:\2023_2\CapstoneProject\mmaction2\23_Capstone_Dataset\dataset\0_gesture_jpg_dataset')
    # print(data_dir_list)
    
    #출력 데이터셋 폴더
    result_folder = r'F:\2023_2\CapstoneProject\mmaction2\23_Capstone_Dataset\dataset\1_gesture_pkl_dataset'
    ...
    #출력 데이터셋 폴더
    result_folder = r'F:\2023_2\CapstoneProject\mmaction2\23_Capstone_Dataset\dataset\2_gesture_pkl_FrameAug'
    make_dir(result_folder)
    ...
    output_path = r'F:\2023_2\CapstoneProject\mmaction2\23_Capstone_Dataset\dataset\gesture_FrameAug30.pkl'
